...
public class Exams implements ArgumentsExam
{
    ...
    /**
     * Процедура получения таблицы {@link Exams#getExamColumnLab(String, String)}
     */
    ...
    /**
     * Функция получения значений {@link ExamText}
    ...
    /**
     * Процедура заполнения ячеек {@link Exams#arrayOfOffersExam}
...
//            correctly[i].setStyle("-fx-border-color: RED");
    ...
    /**
     * Процедура нумерации {@link Exams#number}
     * и получения корректного ответа {@link Exams#arrayOfOffersExam}
     * @param rus - язык значения, Русский
     * @param eng - язык значения, Английский
     */
...
//        examPane.setStyle("-fx-background-color: transparent; -fx-background: #FFFFFF;");
    ...
    /**
     * Процедура подключения {@link Exams#getExamColumnLab(String, String)}
     * к базе данных и занесения в неё значений {@link Exams#arrayOfOffersExam}
     * не равных {@link Exams#improve}
